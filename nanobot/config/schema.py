...
class ChatGPTWebProviderConfig(Base):
    """ChatGPT Web provider configuration (Playwright-driven)."""
...
class ProvidersConfig(Base):
    ...
    chatgpt_web: ChatGPTWebProviderConfig = Field(default_factory=ChatGPTWebProviderConfig)
...
class Config(BaseSettings):
    ...
    def _match_provider(self, model: str | None = None) -> tuple[BaseModel | None, str | None]:
    ...
    def get_provider(self, model: str | None = None) -> BaseModel | None:
        """Get matched provider config object for the selected provider."""
    ...
    def get_api_key(self, model: str | None = None) -> str | None:
        ...
        return str(getattr(p, "api_key", "")) or None
